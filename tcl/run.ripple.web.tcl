...
set stop 10
        ...
        puts $f_throughput " "
        puts $f_throughput "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
        puts $f_throughput "RIPPLE WEB: $numflow"
        puts $f_throughput "RIPPLE WEB: $BER"
...
puts [lindex $BER $i]
                exec ns ripple.web.tcl $stop $rate $basicrate  [lindex $numflow $j] [lindex $BER $i] >> "auto-result.txt" 2> "auto-result.txt"

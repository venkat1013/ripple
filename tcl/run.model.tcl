...
set stop 10
        ...
        set f_throughput  [open "results.model.txt" "a"]
        puts $f_throughput " "
        puts $f_throughput " "
        puts $f_throughput " "
        puts $f_throughput "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
        puts $f_throughput "RIPPLE MODEL: $numflow"
        puts $f_throughput "RIPPLE MODEL: $BER"
...
# puts [lindex $BER $i]
                ...
                exec ns ripple.model.tcl $stop $rate $basicrate  [lindex $numflow $j] [lindex $BER $i] >> "auto-result.txt" 2> /dev/null
...
# puts "snd_num: $snd_num, rcv_num: $rcv_num"
# ------------------ loss rate ------------------

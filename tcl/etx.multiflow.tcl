...
# # # # # # # # # # # # # # ETX2 # # # # # # # # # # # # # # 
    ...
    set f_cwnd  [open "out.etx.cwnd.flow.$flowid.txt" "w"]
    set f_throughput  [open "out.etx.thru.flow.$flowid.txt" "w"]
    set f_rtt  [open "out.etx.rtt.flow.$flowid.txt" "w"]
    close $f_cwnd 
    close $f_throughput 
    close $f_rtt 
...
proc print_stuff { } {
        ...
        for {set i 0} {$i < $opt(fnum)} {incr i} {
                ...
                set f_cwnd  [open "out.etx.cwnd.flow.$flowid.txt" "a"]
                set f_throughput  [open "out.etx.thru.flow.$flowid.txt" "a"]
                set f_rtt  [open "out.etx.rtt.flow.$flowid.txt" "a"]

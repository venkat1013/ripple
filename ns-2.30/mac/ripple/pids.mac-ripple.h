...
class PHY_MIB_RIPPLE {
public:
        PHY_MIB_RIPPLE(MacRipple *parent);
...
class MAC_MIB_RIPPLE {
public:

        MAC_MIB_RIPPLE(MacRipple *parent);
...
public:
        ...
        void      construct_ACK_pIDs( Packet *p, int rcv_array[MAX_FRAGMENTS]);
...
protected:
        PHY_MIB_RIPPLE         phymib_;
        MAC_MIB_RIPPLE         macmib_;
       int     bss_id_;

...
puts [lindex $BER $i]
#                 exec ns etx.multiflow.tcl 10 6 6 [lindex $numflow $j] [lindex $BER $i] >> "auto-result.txt" 2> /dev/null
                exec ns etx.multiflow.tcl 10 216 54  [lindex $numflow $j] [lindex $BER $i] >> "auto-result.txt" 2> /dev/null
        }
 }

...
set stop 10
        ...
        puts $f_throughput " "
        puts $f_throughput "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
        puts $f_throughput "RIPPLE VOIP: $numflow"
        puts $f_throughput "RIPPLE VOIP: $BER"
...
# puts [lindex $BER $i]
                ...
                exec ns ripple.voip.tcl $stop $rate $basicrate  [lindex $numflow $j] [lindex $BER $i] >> "auto-result.txt" 2> /dev/null

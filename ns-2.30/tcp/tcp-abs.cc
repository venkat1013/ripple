 ...
 * $Id: tcp-abs.cc,v 1.1.1.1 2008/12/09 11:15:35 ripple Exp $
 *
 ...
 * @(#) $Header: /tianji.cvsroot/newripple/ns-2.30/tcp/tcp-abs.cc,v 1.1.1.1 2008/12/09 11:15:35 ripple Exp $ (LBL)";
 */
